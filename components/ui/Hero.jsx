...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#021B52]">
      {/* Background Glow */}
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:py-24 lg:py-32">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-[#D8A53B]/40 bg-[#D8A53B]/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#D8A53B]">
              <Sparkles size={14} />
            ...
            <h1 className="mt-8 text-5xl font-bold leading-none text-white md:text-6xl lg:text-7xl">
              Printing <span className="text-[#D8A53B]">Excellence.</span>
              <br />
              Delivering{" "}
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/order"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#D8A53B] px-8 py-4 font-semibold text-black transition hover:opacity-90"
              >
                Book an Order
                <ArrowRight size={18} />
              </Link>
            ...
            <div className="mt-10 flex flex-wrap gap-x-8 gap-y-4 text-sm text-white/80">
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} className="text-[#D8A53B]" />
                22+ Services
              </div>
          ...
          <div className="relative mx-auto w-full max-w-xl">
            ...
            <div className="absolute -right-4 top-4 z-20 rounded-3xl bg-white px-5 py-4 shadow-xl">
              <div className="flex gap-1 text-[#D8A53B]">
                {[...Array(5)].map((_, i) => (
            ...
            <div className="absolute -bottom-4 -left-4 z-20 rounded-3xl bg-white px-6 py-5 shadow-xl">
              <div className="text-4xl font-bold text-[#D8A53B]">500+</div>
